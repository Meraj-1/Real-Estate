...
className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
    ...
    <div className='flex justify-end items-center mb-8'>
        <button onClick={prevProject}
          className='p-3 bg-gray-200 rounded-md mr-2' aria-label='Previous Project'>
            <img src={assets.left_arrow}  alt='previous'/>
        </button>
        <button onClick={nextProject} 
        className='p-3 bg-gray-200 rounded-md mr-2' aria-label='next Project'>
            <img src={assets.right_arrow}  alt='next'/>
        </button>
    </div>
    <div className='overflow-hidden'>
        <div className='flex gap-8  translate-transform duration-500 ease-in-out' 
